...
## Superseded By
This ADR has been superseded by the Failure Model Node Specification
(`schemas/failure-model/node-spec.md`), which defines the current node structure
and relationship field names.
