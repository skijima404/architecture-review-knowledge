...
## Superseded By
This ADR has been superseded by the Backcasting Map Node Specification (`docs/backcasting-map-spec.md`), which defines the current node structure and relationship field names used for Backcasting Maps.