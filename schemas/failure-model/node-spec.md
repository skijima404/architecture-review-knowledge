# Failure Model Node Specification (Markdown v0)
...
- Fix the output requirements for authoring and conversion tools
...
- Any conversion or context-assembly pipeline should treat this frontmatter
  specification as its success criteria
