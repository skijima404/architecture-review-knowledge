...
Designed to be replaceable with Miro MCP client in the future.
"""
...
def get_miro_client(access_token: str | None = None) -> MiroClientBase:
    """Factory function to get a Miro client.

    Currently returns REST client. In the future, could return MCP client
