...
class GeneratorConfig:
    ...
    def get_output_folder(
        ...
        Args:
            ...
            miro_root: tool folder path (for relative paths starting with ./)
        ...
        if self.base_path.is_absolute():
            ...
            # Relative to the tool folder (starts with ./)
...
def generate_all(
    ...
    Args:
        ...
        repo_root: Repository root path
        miro_root: Miro-to-Failure-Model tool path
    ...
    for node_type, nodes in nodes_by_type.items():
        ...
        for node in nodes:
            ...
            # Determine output path before generating content. A stale export may
            # not contain existing_match even though the canonical file exists.
            node_id = node["id"]
